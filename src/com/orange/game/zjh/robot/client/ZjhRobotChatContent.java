...
public class ZjhRobotChatContent {
	
	private final static int IDX_CONTENT = 0;
	private final static int IDX_CONTENTID = 1;
	
	private ZjhRobotChatContent() { }
	private static ZjhRobotChatContent chatContent = new ZjhRobotChatContent();
	
	public static ZjhRobotChatContent getInstance() {
		return chatContent;
	}
